                ...
                <div class="center_content">
                    <div class="prod_box" style="font-size: 16px;">
                        <table width="600px">
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ?>
                                <tr><td><?php echo $row['orderid'] ?></td><td><?php echo $row['pid'] ?></td><td><?php echo $row['name'] ?></td><td><?php echo $row['rate'] ?></td><td><?php echo $row['disrate'] ?></td><td>1</td><td><?php echo $row['disrate'] ?></td></tr>
                                <?php
                            }
                            ?> 
                        </table>
                        <div style="margin-top: 30px; width: 600px;">
                            <span style="float: left; width: 280px; background-color: darkcyan"><a href="index.php">Continue to Shop</a></span>
                            <span style="float: left;width: 280px; background-color: antiquewhite"><a href="Login.php">Check Out</a></span>
