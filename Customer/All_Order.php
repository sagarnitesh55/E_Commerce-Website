<html>
    ...
    <center>
        ...
        try {
            ...
            $sql="select t.orderid,p.pid,p.name,p.rate,1 as qty,p.rate as total from tb_order o,temp_order t,product p where ( o.userid='$userid' and t.orderid=o.orderid and t.pid=p.pid)";
